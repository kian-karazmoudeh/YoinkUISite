...
const YoinkFile = (props: YoinkFile) => {
  return (
    <Link
      ...
      className="leading-[1.42857] w-full min-w-0 text-sm flex relative flex-col gap-2  p-3 rounded-md cursor-pointer border border-zinc-800 hover:bg-zinc-900 hover:border-l-4 hover:border-l-sky-400 transition-all duration-300"
    >
