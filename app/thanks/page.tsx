        ...
        <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20">
              <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
                <div className="flex space-x-5 items-center mx-auto">
                  <h1 className="md:text-6xl text-4xl font-bold text-center w-full">Thank you!</h1>
                </div>
                <p className="text-zinc-700 text-center w-full">You will be the first to hear when we launch!</p>
